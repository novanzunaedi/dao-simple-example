...
public class SaveDialogFragmentMovies extends DialogFragment {
    ...
    public static SaveDialogFragmentMovies newInstance(final String movieTitle, final String movieDirectorFullName) {
        SaveDialogFragmentMovies fragment = new SaveDialogFragmentMovies();
